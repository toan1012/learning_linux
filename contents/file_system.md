...
### 1. Đưa danh sách các file và thư mục con của thư mục hiện tại
...
### 2. Tìm kiếm trong thư mục hoặc đường dẫn
...
### 4. Giới hạn độ sâu cây thư mục tìm kiếm
...
### 5. Tìm kiếm file, thư mục kiểu không phù hợp với tên hoặc pattern.
...
### 6. Gộp nhiều điều kiện tìm kiếm 
...
### 7. Search chỉ file hoặc thư mục
...
### 8. Search trong những thư mục khác nhau
...
### 10. Tìm kiếm file dựa vào chính xác permission
...
### 11. Find files with sgid/suid bits set
...
### 13. Tìm kiếm file có khả năng thực thi
...
### 14. Find files belonging to particular user
...
### 20. Find empty files and directories
...
### 21. Delete all matching files or directories
